        ...
        while (iter.next()) {
            if (iter.isShortcut()) {
                given.add(new Shortcut(
                        ...
                        PrepareEncoder.isFwd(iter.getCHFlags()), PrepareEncoder.isBwd(iter.getCHFlags()),
